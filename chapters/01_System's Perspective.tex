Throughout the courses we are given the task of continuously improve and add features to a legacy code base. The code base in question as an aging mini version of Twitter called \textit{Minitwit}. 
